                ...
                <div class="column">
                    <div class="row">
                        ...
                        <div class="flex padding faci-block2">
                            ...
                            <p class="textgrey">There are viewing rooms available to users to view selected programs related to teaching, learning,
                                research and consultation. Prior booking is made at the Media Counter. Viewing Room which
                                can accommodate a maximum of 100 users.
                            </p>
                        </div>
                        <div class="flex padding faci-block3">
                            ...
                            <p class="textgrey">These rooms can only be used by registered library members. Prior booking is made at the Circulation
                                Counter. These rooms can only be used for 2 hours (max) and can accommodate a maximum of
                                3 to 6 users. Users are responsible for ensuring that the room is kept neat and the electricity
                                is turned off before leaving.</p>
                            <img src="../image/bilikperbincangan1.jpg" class="img-faci" />
                        </div>
                        <div class="flex padding faci-block4">
                            <h3>Viewing Area</h3>
                            <p class="textgrey">Through space can accommodate about 49 users at one time. This space is provided for users to
                                watch exhibition activities provided by the Library UTeM and the freedom of entry and exit.
                                Orders may also be allowed if there is a demand for the use of a group. Also equipped with
                                a television, LCD projector, screen, tables and chairs.</p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="flex padding faci-block2">
                            ...
                            <p class="textgrey">This room provides 48 computers for user to accessi the online databases. Orders may also be
                                allowed if there is a demand for the use of a group. Also equipped with an LCD projector
                                and screen</p>
                        ...
                        <div class="flex padding faci-block1">
                            ...
                            <p class="textgrey">Fines will be imposed at 20 cents per day for overdue, RM1 for the lost of keychain and RM10
                                for the lost of keys.</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="flex padding faci-block3">
                            <h3>Open Carrel </h3>
                            <p class="textgrey">There are 32 open carrels available for users at the Main Campus and 7 open carrels at the City
                                Campus. The rooms can be accessed anytime during the library's operational hour.</p>
                        </div>
                        <div class="flex padding faci-block4">
                            <h3>Laptop</h3>
                        ...
                        <div class="flex padding faci-block2">
                            ...
                            <p class="textgrey">Users can use photocopying service by using topup (Minimum RM5) at the Circulation Counter or
                                PPPK</p>
                    ...
                    <div class="row">
                        <div class="flex padding faci-block2">
                            <h3>iPad Lending</h3>
                            <p class="textgrey">Users can borrow our iPad for free as long as its being used in the library. For further info,
                                click here
                            </p>
                        </div>
                        <div class="flex padding faci-block3">
