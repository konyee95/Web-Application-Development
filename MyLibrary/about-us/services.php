        ...
        <div class="about-us-container margin-leftright">
            ...
            <div class="about-us-container-row">
                <div id="borrowing" class="about-us-row-item service-block1">
                    ...
                    <p class="textgrey">Only individuals registered with the Library may borrow books. Books can be borrowed at the Circulation
                        Counter or Self-check Machine. Borrowers will be given a slip for reference. Borrowers are encouraged
                        to view their borrowing transactions online.The borrowing of all Media Resources like cassette video,
                        cassette audio, slades and digital sources like video CD, CD-ROM, diskette and DVD should be done
                ...
                <div id="returning" class="about-us-row-item service-block2">
                    ...
                    <p class="textgrey">Library materials borrowed must be returned to the Circulation Counter or by book drop which is available
                        ...
                        all library materials when they withdraw, discontinue, defer or graduate from the university programme
                    </p>
                </div>
            </div>
            ...
            <div class="about-us-container-row">
                <div id="reminder" class="about-us-row-item service-block2">
                    ...
                    <ul>
                        ...
                        <li>After one week of the due date, the first reminder notice will be made and 1 week grace period will
                            be given. Fines will not be imposed during this period.</li>
                        <li>The second reminder notice will be issued one week after the first notice, and fines will be imposed.
                        </li>
                        <li>The last reminder notice (third) will be issued two weeks after the second notice, and fines will
                            be calculated accordingly.</li>
                    </ul>
                </div>
                <div id="renewal" class="about-us-row-item service-block1">
                    ...
                    <p class="textgrey">Books can be renewed two (2) times only. Renewal can be done at the Circulation Counter or through online
                        and should be done before the due date. Library materials which have been borrowed may be renewed
                        provided that they have not been reserved by another user and have not had any over due date or fines.</p>
                </div>
            </div>
            ...
            <div class="about-us-container-row">
                <div id="reservation" class="about-us-row-item service-block1">
                    ...
                    <p class="textgrey">Only on loan books may be reserved. Reservations can be made at the Circulation Counter or through online.
                        Reservation notice will be posted on the notice board. Materials reserved will be kept for one week
                        only. The failure to collect will result in the materials being returned to the stacks.
                    </p>
                </div>
                <div id="lost-or-damaged-items" class="about-us-row-item service-block2">
                    ...
                    <p class="textgrey">If a material is lost or damaged, an immediate report should be made to the Circulation Counter to enable
                        appropriate action. A grace period of two weeks will be given to borrowers to search/replace the
                        materials. If the items are still missing, the borrower should replace the items in one of the following
                        three (3) ways including overdue fines (if imposed).</p>
                    <ul>
                        <li>Replace the book: the latest edition; Or</li>
                        <li>Pay the current cost together with RM25 service cost; Or</li>
                        <li>If the cost of the old item could not be deternined, locally published materials will be charged
                            RM40 and imported materials RM150 in addition to the service cost of RM25.</li>
                    </ul>
                </div>
            </div>
        </div>
